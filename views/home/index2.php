...
<head>
	...
	<link rel="stylesheet" href="/public/vendors/bootstrap/flexslider.css">
			...
			<nav class="navbar">
				<div class="container">
					...
					<div class="navbar-header">
						<a href="index.html" class="navbar-brand"><img class="logo" src="/public/img/logo-tiny.png" alt=""></a>
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div class="service-footer-right">
					<button class="btn btn-adjust">book now</button>
				</div>
			</div>
		</div>
	</div>
...
<script src="/public/vendors/jquery/jquery.flexslider.js"></script>
<script src="/public/vendors/jquery/jquery.inview.js"></script>
